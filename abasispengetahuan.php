  ...
  <p><a href="logout.php"><button type="button" class="btn btn-primary btn-block" id="myBtn">LOGOUT</button></a></p>
    ...
    <div class="col-sm-8 text-left"> 
        ...
        <br><form id="form1" name="form1" method="post">
               ...
               <?php 
 			        $tampil="select * from penyakit where bagiatubuh= \"".$_POST['tubuh']."\"";
...
<form id="form2" name="form2" method="post" action="diagnosa.php">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='akar' and bagiatubuh= \"".$_POST['tubuh']."\"";
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">BATANG</div>
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='batang' and bagiatubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
     ...
     <div class="panel panel-primary">
        <div class="panel-heading">DAUN</div>
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='daun' and bagiatubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
     ...
     <div class="panel panel-primary">
        <div class="panel-heading">BUAH/UMBI</div>
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='Buah/Umbi' and bagiatubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">BUNGA</div>
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='bunga' and bagiatubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">BIJI</div>
            ...
            if(isset($_POST['tubuh']))
                  if($_POST['tubuh']!="bagiatubuh"){
 			$tampil="select * from gejala where daerah='biji' and bagiatubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
