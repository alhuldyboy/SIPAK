    ...
    <div class="col-sm-8 text-left"> 
      <center><h2>DIAGNOSA PENYAKIT</h2></center>
        <form id="form1" name="form1" method="post" action="diagnosa.php">
				<label for="sel1">Jenis tubuh</label>            
				<select class="form-control" name="tubuh" onChange='this.form.submit();'>
				<option>tubuh</option>
       ...
       <br>     
        <form id="form2" name="form2" method="post" action="diagnosa.php">
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='akar' and bagiantubuh= \"".$_POST['tubuh']."\"";
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='batang' and bagiantubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='daun' and bagiantubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='Buah/Umbi' and bagiantubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='bunga' and bagiantubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
            ...
            if(isset($_POST['tubuh']))
 			...
 			$tampil="select * from gejala where daerah='biji' and bagiantubuh= \"".$_POST['tubuh']."\"";
			$query= mysqli_query($konek_db,$tampil);
                while($hasil=mysqli_fetch_array($query)){  
					echo "<input type='checkbox' value='".$hasil['gejala']."' name='gejala[]' /> ".$hasil['gejala']."<br>";
			}
        ...
        if(isset($_POST['submit'])){
           ...
           for($x=0;$x<$jumlah_dipilih;$x++){
                       $tampil ="select DISTINCT p.idpenyakit, p.namapenyakit, p.bagiantubuh from basispengetahuan b, penyakit p where b.gejala='$gejala[$x]' and p.namapenyakit=b.namapenyakit group by namapenyakit";
